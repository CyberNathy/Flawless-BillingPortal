...
<head>
    ...
    <!-- Title -->
    <title>Flawless Pool Services | Elk Grove | About Us</title>
                            ...
                            <div class="header-top-card">
                                <ul>
                                    <li>
                                        ...
                                        <a href="mailto:info@flawlesspoolservices.com">info@flawlesspoolservices.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="header-top-card">
                                <ul>
                                    <li>
                                        ...
                                        <a href="tel:+(704)279-1249">+(916) 620-5020</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="contact-section pt-100 pb-70">
        <div class="container">
            <div class="section-title text-center">
                <span>contact</span>
                <h2 class="margin-auto color-title-blue">Get in Touch</h2>
            </div>
            <div class="row pt-45">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact-card">
                        <i class="flaticon-email"></i>
                        <h3><a href="mailto:info@flawlesspoolservices.com">Email:info@flawlesspoolservices.com</a></h3>
                        <h3><a href="mailto:support@flawlesspoolservices.com">Email:support@flawlesspoolservices.com</a></h3>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                    <div class="contact-card">
                        <i class="flaticon-phone-call"></i>
                        <h3><a href="tel:+1(916)6205020">+1 (916) 620-5020</a></h3>
                        <h3><a href="tel:+1(916)6205020">+1 (916) 620-5020</a></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="contact-left-side">
                        <h2>HAVE ANY KIND QUESTION PLEASE DONT HESITATE! CONTACT US!</h2>
                        <p>
                            We are looking forward to hearing from you and are always glad to help.
                            Give us a call or drop us a line, even if it's just to say hello! cleaning and pool equipment repair for the Area! We are master
                        </p>
                        <p>
                            Fill out the form below and send us a message. Someone from our team will assist you
